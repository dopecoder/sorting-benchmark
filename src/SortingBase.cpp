...
void SortingBase::initializeNumbersArray()
{
    ...
    {
        // cout << "NUMBER : " << temporaryNumber << endl;
        numbers[counter] = arraySize - counter;
        counter++;
...
void SortingBase::writeNumbers()
{
    ...
    if (isVerbose)
    {
        ...
        cout << "\t\t    " << runningTime << " microseconds - "
             << runningTime / 1000 << " milliseconds." << endl
             << endl;
        cout << "--------------------------------------------------------------------------------" << endl
             << endl;
        ...
        cout << "\b\b\b"
             << "100% - Success";
        cout << endl
             << "\tThe numbers have successfully been sorted and written into " << this->outputFile;
        cout << endl
             << endl;
        cout << "--------------------------------------------------------------------------------" << endl
             << endl;
